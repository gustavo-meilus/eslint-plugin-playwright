...
const findFirstBlockBodyUp = (
  ...
  throw new Error(
    `Could not find BlockStatement - please file a github issue at https://github.com/gustavo-meilus/eslint-plugin-playwright`,
  )
}
...
export default createRule({
  ...
  meta: {
    docs: {
      ...
      recommended: true,
      url: 'https://github.com/gustavo-meilus/eslint-plugin-playwright/tree/main/docs/rules/valid-expect-in-promise.md',
    },
    messages: {
